...
import com.zerobase.festlms.course.entity.TakeCourseCode;
import com.zerobase.festlms.course.mapper.TakeCourseMapper;
import com.zerobase.festlms.course.model.ServiceResult;
import com.zerobase.festlms.course.model.TakeCourseParam;
import com.zerobase.festlms.course.repository.TakeCourseRepository;
...
public class TakeCourseServiceImpl implements TakeCourseService{
    ...
    public List<TakeCourseDto> myCourse(String userId) {
        TakeCourseParam paramter = new TakeCourseParam();
        paramter.setUserId(userId);
        List<TakeCourseDto> list = takeCourseMapper.selectListMyCourse(paramter);
