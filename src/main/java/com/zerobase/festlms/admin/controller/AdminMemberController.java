...
import com.zerobase.festlms.admin.model.MemberInput;
...
import com.zerobase.festlms.util.PageUtil;
...
public class AdminMemberController extends BaseController {
    ...
    private final HistoryMemberRepository historyMemberRepository;
    ...
    public String detail(Model model, MemberParam parameter) {
        ...
        List<MemberHistory> historyList = historyMemberRepository.findByUserIdOrderByLoginDtDesc(parameter.getUserId()).get();
    ...
    @PostMapping("/admin/memeber/password.do")
